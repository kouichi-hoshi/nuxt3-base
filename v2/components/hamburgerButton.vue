<template>
  <component :is="tagName" class="hamburger-button small">
    <div :id="btnId" :class="{ active: hamburgerActive }" class="btn-trigger" @click="hamburger()">
      <span></span>
      <span></span>
      <span></span>
    </div>
...
.hamburger-button {
  ...
  #btn07 {
    ...
    & > span {
      background: map-get(variables.$theme-base-colors, cWhite) !important;
    }
  }
